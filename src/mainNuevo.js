 ...
 * @returns 
 */
async function listenForm(formID) {
    const userData = await validateForm();
    console.log("Esto es data " + userData);
    console.log("email + pass lista: " + userData.email + " " + userData.password);
    ...
    sendValidatedData(formID, userData.email, userData.password);
 ...
 * @param {*} password 
 */
async function sendValidatedData(formID, email, password) {
...
async function validateForm() {
    ...
    // Inputs are valid
    console.log("antes return validate: " + email.value + "   " + password.value);
    return {
        email: email.value,
...
(async () => {
    ...
    const signInHandler = async () => {
        ...
        await listenForm('formSignIn', userData);
    };
    ...
    const signUpHandler = async () => {
        ...
        const userData = await validateForm();
        console.log("userdata :" + userData.email + " " + userData.password  );
        await sendValidatedData('formSignUp', userData.email, userData.password);
    };
