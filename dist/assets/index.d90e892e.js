...
import { getFirestore, addDoc, collection, query, where, orderBy, getDocs, doc, deleteDoc, updateDoc, arrayUnion, getCountFromServer } from "https://www.gstatic.com/firebasejs/9.19.0/firebase-firestore.js";
(function polyfill() {
...
async function editPost(postId, post2) {
  console.log("postid en Edit:", postId);
  console.log("post  en Edit: ", post2);
  console.log("post author: ", post2.author);
  post2.userId;
...
async function getPosts() {
  ...
  await Promise.all(
    querySnapshot.docs.map(async (doc2) => {
      ...
      smallColleagues.classList.add("location");
      smallColleagues.textContent = `Lugar: ${post2.location ? post2.location : "Indefinida"}`;
